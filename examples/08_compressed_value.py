...
- Sustainable dividends""",
        ...
        self.compressor = SemanticCompressor(
            provider="ollama", compression_model="llama3.2"  # Cheap model for compression
        )
    ...
    async def analyze(self, ticker: str, data: dict) -> Signal:
        ...
        print(
            f"  🗜️  Compression: {original_tokens} → {compressed_tokens} tokens "
...
Example: bullish|75|Low PE ratio and strong margins provide margin of safety"""
        ...
        try:
            ...
            return Signal(
                direction="neutral", confidence=0.3, reasoning=f"Analysis error: {str(e)[:100]}"
            )
    ...
    try:
        ...
        for ticker in tickers:
            ...
            if "compression" in signal.metadata:
                ...
                print(
                    f"  💰 Saved: ${comp['net_savings_usd']:.4f} "
        ...
        monthly = calculate_monthly_savings(
            analyses_per_day=100, compression_reduction=0.75  # 100 stocks/day
        )
