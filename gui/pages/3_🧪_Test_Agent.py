...
from gui.components.test_config import configure_test_data, TestDataConfig
...
def execute_and_display_test(agent_info: Dict, test_config: TestDataConfig):
    ...
    with progress_placeholder.container():
        ...
        # Execute test
        tester = AgentTester()
        uploaded_file = test_config.uploaded_file if test_config.source == "pdf" else None
        ...
        result = tester.test_agent(
            ...
            agent_class_name=agent_info["name"]
        )
